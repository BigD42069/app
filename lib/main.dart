...
class _TransferViewState extends State<_TransferView> {
  ...
  /// Startet den GET_FILE-Abruf. Die Animation beginnt erst, wenn das Gerät
  /// den BEGIN-Status sendet und `_startFileWrite` dadurch ausgelöst wird.
          ...
          children: [
            ...
            Row(
              children: [
                ...
                CupertinoButton(
                  padding: EdgeInsets.zero,
                  onPressed: _requestInFlight ? null : startTransfer,
                  child: Container(
                    padding: const EdgeInsets.symmetric(
                      horizontal: 18,
                      vertical: 12,
